package ws.xinyuan.repository;

import ws.xinyuan.JhipsterSampleApplicationApp;
import ws.xinyuan.config.Constants;
import ws.xinyuan.config.audit.AuditEventConverter;
import ws.xinyuan.domain.PersistentAuditEvent;
...
import static ws.xinyuan.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
